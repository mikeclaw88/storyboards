...
export function GolfCourseRenderer() {
  ...
  useEffect(() => {
    ...
    // OPTIMIZED: InstancedMesh for trees
  ...
  useFrame(({ camera }) => {
    ...
    // Note: InstancedMesh billboard logic requires custom shader or CPU updates. 
    // Skipping CPU update for 4000 instances to maintain performance.
  });
