...
export function GameHUD() {
  ...
  return (
    <div className="absolute top-6 left-6 z-10 font-mono text-white pointer-events-auto">
      {/* Scoreboard */}
      ...
      {/* Shot Result Popup */}
      {showResult && (
        <div className="mt-4 bg-black/70 p-4 rounded-lg backdrop-blur-md border border-[#4ade80] animate-in fade-in slide-in-from-left-4 duration-300 w-64">
          ...
          >
            {currentShot >= maxShots ? "FINISH ROUND" : "NEXT SHOT"}
          </button>
        </div>
      )}
    </div>
