...
const swordSvg = `<svg width="512" height="512" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">
...
swordImage.src = 'data:image/svg+xml,' + encodeURIComponent(swordSvg);
class UnitSword extends BodyPart {
    ...
    _draw(ctx, offsets = { _position: new Vector(0, 0), r: 0 }) {
        ...
        ctx.translate(this.Position.x + offsets._position.x, this.Position.y + offsets._position.y);
        ctx.rotate(this._rotation + offsets.r);
        // Flip vertically: SVG has blade pointing UP, code expects blade DOWN (+Y)
        ctx.scale(1, -1);
        ctx.drawImage(swordImage, 0, -this._length - 5, this._size.x, this._length + 5);
        ctx.restore();
    }
}
